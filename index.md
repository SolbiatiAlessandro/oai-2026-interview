...
Catalog of every wiki page in this KB. Re-generate this list after adding,
renaming, or splitting pages.
...
## Rounds (`wiki/rounds/`)
- [Recruiter / Hiring-manager screen](wiki/rounds/recruiter.md)
- [Coding (general SWE)](wiki/rounds/coding.md)
- [ML coding](wiki/rounds/ml-coding.md)
- [ML debugging (fix-the-broken-transformer)](wiki/rounds/ml-debugging.md)
- [System design](wiki/rounds/system-design.md)
- [ML system design](wiki/rounds/ml-system-design.md)
- [ML search/recsys design](wiki/rounds/ml-search-design.md)
- [Deep dive (project retrospective)](wiki/rounds/deep-dive.md)
- [Technical project presentation (staff)](wiki/rounds/technical-project-presentation.md)
- [Behavioral / mission-fit](wiki/rounds/behavioral.md)
...
- [`CLAUDE.md`](CLAUDE.md) — schema and operations.
